...
class Invoice extends Document
{
    ...
    {
        $mapped = eac_invoice_status_label_for_status((string) $this->status);
        if ("" !== $mapped) {
            return $mapped;
        }
    ...
    public function get_next_number()
    {
        ...
        $number = str_pad(
            $max + 1,
            get_option("eac_invoice_digits", 4),
            "0",
            STR_PAD_LEFT,
        );
    ...
    {
        return "yes" === get_option("eac_tax_enabled", "no") ||
    ...
    {
        return admin_url(
            "admin.php?page=eac-sales&tab=invoices&action=edit&id=" . $this->id,
        );
    }
    ...
    {
        return admin_url(
            "admin.php?page=eac-sales&tab=invoices&action=view&id=" . $this->id,
        );
    }
