...
class DocumentItem extends Model
{
    ...
    protected $table = "otto_document_items";
    ...
    public function save()
    {
        if (empty($this->type)) {
            return new \WP_Error(
                "required_missing",
                __("Product type is required.", "otto-contracts"),
            );
        }
        ...
        if (empty($this->quantity)) {
            return new \WP_Error(
                "required_missing",
                __("Product quantity is required.", "otto-contracts"),
            );
        }
        ...
        if (empty($this->document_id)) {
            return new \WP_Error(
                "required_missing",
                __("Document ID is required.", "otto-contracts"),
            );
        }
