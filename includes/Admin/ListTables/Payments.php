...
class Payments extends ListTable
{
    ...
    {
        if (!current_user_can("eac_delete_payments")) {
    ...
    {
        esc_html_e("No payments found.", "otto-contracts");
    }
    ...
    public function get_columns()
    {
        return [
            ...
            "number" => __("Payment #", "otto-contracts"),
            "date" => __("Date", "otto-contracts"),
            "account_id" => __("Account", "otto-contracts"),
            "customer_id" => __("Customer", "otto-contracts"),
            "invoice_id" => __("Contract", "otto-contracts"),
    ...
    public function column_date($item)
    {
        return $item->payment_date
            ? eac_format_datetime($item->payment_date, eac_date_format())
            : "&mdash;";
    }
    ...
    protected function handle_row_actions($item, $column_name, $primary)
    {
        ...
        if (!$item->editable || !current_user_can("eac_edit_payments")) {
