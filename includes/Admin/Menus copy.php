    ...
    public function render_page()
    {
       ...
       count($this->tabs[$this->current_page]) > 1
				...
				<nav class="nav-tab-wrapper eac-navbar">
					<?php foreach ($this->tabs[$this->current_page] as $name => $label) {
         printf(
