 ...
 *
 * @var \Jjpsos\ContractPilot\Admin\ListTables\Items|null $contract_pilot_list_table
...
?>
    <h1 class="wp-heading-inline">
        <?php esc_html_e('Services', 'contract-pilot'); ?>
    ...
    <form method="get" action="<?php echo esc_url(admin_url('admin.php')); ?>">
        ...
        <input type="hidden" name="page" value="contract-pilot-items"/>
