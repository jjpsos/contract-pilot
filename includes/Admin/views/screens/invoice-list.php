...
/**
 * Contracts/Bills list screen.
 *
 * @var \Jjpsos\ContractPilot\Admin\ListTables\Invoices|null $contract_pilot_list_table
 * @var string                                              $contract_pilot_filter_status
 */
...
?>
    <h1 class="wp-heading-inline">
        <?php esc_html_e('Contracts', 'contract-pilot'); ?>
    ...
    <form method="get" action="<?php echo esc_url(admin_url('admin.php')); ?>">
        ...
        <input type="hidden" name="status" value="<?php echo esc_attr($contract_pilot_filter_status); ?>"/>
    </form>
