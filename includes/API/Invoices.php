...
class Invoices extends Documents
{
    ...
    public function get_items_permissions_check($request)
    {
        if (!current_user_can("eac_read_invoices")) {
            ...
            return new \WP_Error(
                ...
                __(
                    "Sorry, you are not allowed to view contracts.",
                    "otto-contracts",
                ),
    ...
    public function create_item_permissions_check($request)
    {
        if (!current_user_can("eac_edit_invoices")) {
            ...
            return new \WP_Error(
                "rest_forbidden_context",
                __(
                    "Sorry, you are not allowed to create contracts.",
                    "otto-contracts",
                ),
                ["status" => rest_authorization_required_code()],
            );
    ...
    public function get_item_permissions_check($request)
    {
        ...
        if (empty($invoice) || !current_user_can("eac_read_invoices")) {
            
            return new \WP_Error(
                "rest_forbidden_context",
                __(
                    "Sorry, you are not allowed to view this contract.",
                    "otto-contracts",
                ),
                ["status" => rest_authorization_required_code()],
            );
    ...
    public function update_item_permissions_check($request)
    {
        ...
        if (empty($invoice) || !current_user_can("eac_edit_invoices")) {
            
            return new \WP_Error(
                "rest_forbidden_context",
                __(
                    "Sorry, you are not allowed to update this contract.",
                    "otto-contracts",
                ),
                ["status" => rest_authorization_required_code()],
            );
    ...
    public function delete_item_permissions_check($request)
    {
        ...
        if (empty($invoice) || !current_user_can("eac_delete_invoices")) {
            
            return new \WP_Error(
                "rest_forbidden_context",
                __(
                    "Sorry, you are not allowed to delete this contract.",
                    "otto-contracts",
                ),
                ["status" => rest_authorization_required_code()],
            );
    ...
    public function get_item_schema()
    {
        $schema = [
            ...
            "properties" => [
                ...
                "items" => [
                    "description" => __("Line services on the contract.", "otto-contracts"),
                    "type" => "array",
                    "context" => ["view", "edit"],
                    "items" => [
                        "type" => "object",
                ...
                "date_updated" => [
                    "description" => __(
                        'The date the contract was last updated, in the site\'s timezone.',
                        "otto-contracts",
                    ),
                    "type" => "date-time",
                    "context" => ["view", "edit"],
                ...
                "date_created" => [
                    "description" => __(
                        'The date the contract was created, in the site\'s timezone.',
                        "otto-contracts",
                    ),
                    "type" => "date-time",
                    "context" => ["view", "edit"],
