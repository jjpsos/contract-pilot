...
class Vendors extends Contacts {
	...
	public function get_items_permissions_check( $request ) {
		if ( ! current_user_can( 'eac_read_vendors' ) ) { 
			return new \WP_Error(
				'rest_forbidden_context',
				__( 'Sorry, you are not allowed to view Vendors.', 'otto-contracts' ),
	...
	public function create_item_permissions_check( $request ) {
		if ( ! current_user_can( 'eac_edit_vendors' ) ) { 
			return new \WP_Error(
				'rest_forbidden_context',
				__( 'Sorry, you are not allowed to create vendor.', 'otto-contracts' ),
				array( 'status' => rest_authorization_required_code() )
			);
		}
	...
	public function update_item_permissions_check( $request ) {
		...
		if ( empty( $vendor ) || ! current_user_can( 'eac_edit_vendors' ) ) { 
			return new \WP_Error(
				'rest_forbidden_context',
				__( 'Sorry, you are not allowed to update this vendor.', 'otto-contracts' ),
				array( 'status' => rest_authorization_required_code() )
			);
		}
	...
	public function get_item_permissions_check( $request ) {
		...
		if ( empty( $vendor ) || ! current_user_can( 'eac_read_vendors' ) ) { 
			return new \WP_Error(
				'rest_forbidden_context',
				__( 'Sorry, you are not allowed to view this vendor.', 'otto-contracts' ),
				array( 'status' => rest_authorization_required_code() )
			);
		}
	...
	public function delete_item_permissions_check( $request ) {
		...
		if ( empty( $vendor ) || ! current_user_can( 'eac_delete_vendors' ) ) { 
			return new \WP_Error(
				'rest_forbidden_context',
				__( 'Sorry, you are not allowed to delete this vendor.', 'otto-contracts' ),
				array( 'status' => rest_authorization_required_code() )
			);
		}
	...
	public function create_item( $request ) {
		if ( ! empty( $request['id'] ) ) {
			return new \WP_Error(
				'rest_exists',
				__( 'Cannot create existing vendor.', 'otto-contracts' ),
				array( 'status' => 400 )
			);
		}
	...
	public function delete_item( $request ) {
		...
		if ( ! $vendor->delete() ) {
			return new \WP_Error(
				'rest_cannot_delete',
				__( 'The vendor cannot be deleted.', 'otto-contracts' ),
				array( 'status' => 500 )
			);
		}
	...
	public function get_item_schema() {
		...
		$schema['title'] = __( 'Vendor', 'otto-contracts' );
