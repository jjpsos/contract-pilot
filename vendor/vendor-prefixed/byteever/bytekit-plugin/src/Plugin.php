...
namespace Otto\ByteKit;

use Otto\ByteKit\Admin\Flash;
use Otto\ByteKit\Admin\Notices;
use Otto\ByteKit\Interfaces\Pluginable;
use Otto\ByteKit\Traits\HasPlugin;
...
abstract class Plugin implements Pluginable
{
    ...
    protected function __construct($data)
    {
        ...
        // Register hooks.
        add_action("init", [$this, "_register_textdomain"]);
        add_action("init", [$this, "_register_scripts"]);
    ...
    public function _register_scripts()
    {
        ...
        $this->scripts->register_style(
            "bytekit-layout",
            plugin_dir_url(__FILE__) . "assets/css/bytekit-layout.css",
        );
        $this->scripts->register_style(
            "bytekit-components",
            plugin_dir_url(__FILE__) . "assets/css/bytekit-components.css",
        );
        $this->scripts->register_script(
            "bytekit-admin",
            plugin_dir_url(__FILE__) . "assets/js/bytekit-admin.js",
            ["jquery"],
        );
    }
    /**
