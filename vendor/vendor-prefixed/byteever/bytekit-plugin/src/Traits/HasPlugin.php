...
trait HasPlugin
{
    ...
    public function get_plugin_meta_links()
    {
        ...
        return apply_filters(
            $this->get_prefix() . "_plugin_meta_links",
            $links,
        );
    }
    /**
    ...
    public function get_plugin_action_links()
    {
        ...
        if (!empty($this->get_settings_url())) {
            $links["settings"] = [
                "label" => __("Settings", "otto-contracts"),
         ...
         */
        return apply_filters(
            $this->get_prefix() . "_plugin_action_links",
            $links,
        );
    }
    /**
